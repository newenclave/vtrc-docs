...
> тут под протоколом понимается не низкий уровень (о нем опишу отдельно), но о протоколе уровня сообщений и сервисов, которыми нужно оперировать при работе с библиотекой
