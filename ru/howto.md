...
Кроме запуска и остановки слушатель имеет возможность сообщить внешнему миру о некоторых своих событиях. Для этого используются сигналы из библиотеки boost (boost::signal2). 
