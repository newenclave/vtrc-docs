...
Реализацию сервиса библиотека получает из метода **get_service_by_name** от наследника vtrc::server::application. Реализация завернута в обертку common::rpc_service_wrapper. 
