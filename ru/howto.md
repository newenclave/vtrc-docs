...
Возникает при соединении клиента с удаленной стороной. После этого сигнала клиент
...
подпишемся на сигналы клиента. Это следует сделать *ДО попытки соединиться с удаленной стороны* иначе синалы можно “пропустить”.
...
Канал для клиента, как и слушатель для сервера может быть TCP либо локальный. 
Допустим у нас есть сервер по адресу 192.168.3.1:12345. 
