...
В первом случае это будет один единственный io_service, и работа с ним будет аналогична тому, как описано выше. Подразумевается, что у пользователя уже есть io_service, который будет использован сервером. 
